...
<audio autoplay loop id="bg-music">
  <source src="sou-de-nana.mp3" type="audio/mpeg">
</audio>
...
<section class="hero container">
  ...
  <div class="hero-content">
    ...
    <a
    href="https://wa.me/5591981093467?text=Obrigada%20meu%20amor%20eu%20amei!!!"
    target="_blank"
    class="btn">
      💌 Falar com meu amor
    </a>

    <p style="margin-top:20px; color:#d9b3ff; font-size:18px;">
      🎵 Abra com som para uma experiência mais especial
    </p>
  ...
  <div class="cards">
    ...
    <div class="card">
      ...
      <p>
        ...
        assim como você tem feito comigo,
        já disse que a minha missão é retribuir
        todo o amor que você me faz sentir.
      </p>
...
<section class="section container">
  ...
  <div class="love-box">
    ...
    <p>
      ...
      Difícil é encontrar palavras suficientes para explicar
      o quanto você significa pra mim.<br><br>

      Eu amo sua voz, seu jeito, suas manias, sua presença,
      sua força, sua delicadeza e até o jeito que você ocupa
      meus pensamentos o dia inteiro.<br><br>

      Se algum dia você duvidar do quanto é especial,
      volta aqui e lembra:
      existe alguém nesse mundo que olha pra você
      como a coisa mais preciosa que a vida poderia oferecer.<br><br>
